...
function buildPython(tool: Tool, params: ToolParams, b64: string): string {
  ...
  if (tool === 'replace_text') {
    script = [
      ...
      '        if text and find_text in text:',
      '            x = tm[4]',
      '            y = tm[5]',
      '            parts.append((text, x, y, fontSize or 10))',
      ...
      '                text_w = len(text) * fsize * 0.55',
      "                c.setFillColor(HexColor('#FFFFFF'))",
      '                c.rect(x - 1, y - 2, text_w + 2, fsize + 4, fill=1, stroke=0)',
      '                # Draw new text in same position',
      "                c.setFillColor(HexColor('#000000'))",
      '                c.setFont("Helvetica", fsize if fsize > 4 else 10)',
